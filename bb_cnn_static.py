...
def  CNN_procedures():
    ...
    corpus = load_files( container_path='bbc', description=None, load_content=True, encoding='utf-8', categories = categories, shuffle=True, decode_error='ignore', random_state = 42 )
    ...
    plt.title('Model accuracy ( CNN-static )')
    plt.ylabel('Accuracy')
    ...
    plt.title('Model loss ( CNN-static ) ')
    plt.ylabel('Loss')
    plt.xlabel('Epoch')
